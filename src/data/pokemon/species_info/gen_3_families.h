...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_VIGOROTH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_SLAKING}),
    },
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_FLYGON}),
    },
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_CHIMECHO, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD},{IF_TIME, TIME_NIGHT})}),
    },
#endif //P_GEN_4_CROSS_EVOS
