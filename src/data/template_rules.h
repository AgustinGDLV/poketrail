...
static const u8 sVolcanoNormalRooms[] =
{
    ...
    MAP_NUM(VOLCANO_TEMPLATES_ROOM2),
    MAP_NUM(VOLCANO_TEMPLATES_ROOM3),
    MAP_NUM(VOLCANO_TEMPLATES_ROOM4),
    MAP_NUM(VOLCANO_TEMPLATES_ROOM5),
    MAP_NUM(VOLCANO_TEMPLATES_ROOM6),
    MAP_NUM(VOLCANO_TEMPLATES_ROOM7),
    MAP_NUM(VOLCANO_TEMPLATES_ROOM8),
    MAP_NUM(VOLCANO_TEMPLATES_ROOM9),
};
...
static const u8 sDesertNormalRooms[] =
{
    ...
    MAP_NUM(DESERT_TEMPLATES_ROOM3),
    MAP_NUM(DESERT_TEMPLATES_ROOM4),
    MAP_NUM(DESERT_TEMPLATES_ROOM5),
    MAP_NUM(DESERT_TEMPLATES_ROOM6),
    MAP_NUM(DESERT_TEMPLATES_ROOM7),
    MAP_NUM(DESERT_TEMPLATES_ROOM8),
};
...
static const u8 sForestNormalRooms[] =
{
    ...
    MAP_NUM(FOREST_TEMPLATES_ROOM2),
    MAP_NUM(FOREST_TEMPLATES_ROOM3),
    MAP_NUM(FOREST_TEMPLATES_ROOM4),
    MAP_NUM(FOREST_TEMPLATES_ROOM5),
    MAP_NUM(FOREST_TEMPLATES_ROOM6),
    MAP_NUM(FOREST_TEMPLATES_ROOM7),
    MAP_NUM(FOREST_TEMPLATES_ROOM8),
...
static const u8 sFieldsNormalRooms[] =
{
    ...
    MAP_NUM(FIELDS_TEMPLATES_ROOM8),
    MAP_NUM(FIELDS_TEMPLATES_ROOM10),
    MAP_NUM(FIELDS_TEMPLATES_ROOM11),
    MAP_NUM(FIELDS_TEMPLATES_ROOM12),
};
